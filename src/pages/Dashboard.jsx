        ...
        <div className="flex pl-5 justify-between items-start">
          ...
          <div className="h-fit w-[79vw] px-5 pt-4">
            <div className=" justify-around  items-center hidden ">
              <Link
                to={"/orders?query=new"}
                className="h-16 w-64 flex justify-center items-center  bg-white  rounded-xl shadow-lg border duration-200 hover:shadow-xl cursor-pointer "
              >
                {orders?.filter((data) => data?.status === "new").length} New
                      ...
                      {orders.map((data, index) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td
                              className={`capitalize cursor-pointer   font-semibold text-lg ${
